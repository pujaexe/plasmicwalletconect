...
// Plasmic Project: fvV8UgSBjqNyEHLCzEKNLv
// Component: ZUyOVEyPxOrR
...
import projectcss from "./plasmic.module.css"; // plasmic-import: fvV8UgSBjqNyEHLCzEKNLv/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: ZUyOVEyPxOrR/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: BST4nyNDjOHF/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: YAk_Vp0y49LL/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mJlFx)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__xscBh)}
                role={"img"}
              />
            ),
